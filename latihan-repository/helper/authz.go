...
// menyimpan pemetaan role ke daftar permission miliknya.
type PermissionSet struct {
	byRole map[string]map[string]struct{}
}

// mengubah hasil query menjadi bentuk yang cepat dicari.
...
// Can menerapkan prinsip fail closed: role/permission tidak dikenal = false.
